...
Springベースのバックエンド開発を志す李 旼宰（イ・ミンジェ）と申します。🙋🏻‍♂️

絶え問ない好奇心で新たな挑戦に積極的に取り組みます。

常に謙虚な姿勢で学びに臨みます。

- プロジェクトリーダー経験および多様なチームとの協業経験
- テストおよびCI/CD経験
- RDBMSに関する理解およびプロジェクト経験

## Experience

- SCITマスター48期 在学中 `2025.09 ~ 2026.04`
- メタバースアカデミー バックエンドコース 3期 修了 `2024.06 ~ 2024.12`
- メタバースアカデミー データサイエンスコース 2期 修了 `2023.08 ~ 2023.12`
- KT AIVLE SCHOOL AI 開発者トラックコース 2期 修了 `2022.07 ~ 2023.01`
